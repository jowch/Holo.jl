...
the crossover-N analysis, and the interaction capability matrix (live pan/zoom/rotate is gated off
today and deferred — see `backend-comparison.md` §1†/§6, not restated here). It reconciles with this
section and the `:cairo` envelope
above.
